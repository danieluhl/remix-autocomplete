...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-autocomplete-6bef
  fly apps create remix-autocomplete-6bef-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-autocomplete-6bef
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-autocomplete-6bef-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-autocomplete-6bef-staging' does not match app name in config file 'remix-autocomplete-6bef'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-autocomplete-6bef-db
  fly postgres attach --app remix-autocomplete-6bef remix-autocomplete-6bef-db

  fly postgres create --name remix-autocomplete-6bef-staging-db
  fly postgres attach --app remix-autocomplete-6bef-staging remix-autocomplete-6bef-staging-db
  ```
